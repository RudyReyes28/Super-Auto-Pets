...
public class Jugador {
    ...
    public void pelear(Jugador enemigo){
        ...
        if(posicionMascota!=-1){
            double ataque = mascotas[posicionMascota].getAtaqueEfectos(enemigo.getMascotas(),this.getNombre());
            ...
            if(posicionEnemigo!=-1) {
                ...
                enemigo.getMascota(posicionEnemigo).setVidaEfectos(-ataque, enemigo.getMascotas(), this.getMascotas(), enemigo.getNombre());
